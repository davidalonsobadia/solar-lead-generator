...
/**
 * Proxy an industry EUI benchmark CSV upload to the backend import endpoint.
 *
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("[Sunscout] Benchmark import error:", error)
    ...
    return NextResponse.json(
      { success: false, message: "Benchmark import failed" },
      { status: 500 },
    )
  }
}
